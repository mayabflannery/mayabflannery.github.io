...
draft = false
title = 'Introducing MAFs: Music acoustic features and their relationship to personality'
tags = ['NeuroMusic', 'Music', 'MIR', 'Personality']
categories = ['Conference', 'Poster']
description = "Experimental investigation into the relationship between personality and musical features."
+++
